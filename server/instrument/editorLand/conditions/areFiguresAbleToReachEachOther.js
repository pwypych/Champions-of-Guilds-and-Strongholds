...
module.exports = () => {
  return (req, res, next) => {
    (function init() {
      debug('// Checks if parcel generated by landGenerateMapPost fullfills condition so figures are able to reach each other');
    ...
    function checkAreFiguresAbleToReachEachOther(parcel) {
      ...
      debug('areFiguresAbleToReachEachOther', isPossible);
      return isPossible;
    }
